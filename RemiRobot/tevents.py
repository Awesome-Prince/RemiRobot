...
from RemiRobot import MONGO_DB_URI
from RemiRobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import SaitamaRobot.tevents

        path = Path(f"RemiRobot/modules/{shortname}.py")
        name = "RemiRobot.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Remi.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "RemiRobot/modules/*.py"
