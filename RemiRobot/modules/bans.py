...
from RemiRobot.modules.helper_funcs.extraction import extract_user_and_text
from RemiRobot.modules.helper_funcs.string_handling import extract_time
from RemiRobot.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if user_id == bot.id:
        message.reply_text("Hello Iam 💖Remi💖,")
        return log_message
