...
import RemiRobot.modules.sql.welcome_sql as sql
from RemiRobot import (DEV_USERS, LOGGER, OWNER_ID, DRAGONS, DEMONS, TIGERS,
                          WOLVES, sw, dispatcher, JOIN_LOGGER)
from RemiRobot.modules.helper_funcs.chat_status import (
    is_user_ban_protected,
    user_admin,
)
from RemiRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from RemiRobot.modules.helper_funcs.msg_types import get_welcome_type
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_photo(
                    "https://telegra.ph/file/275763c3d023163a68eb7.jpg",
                    reply_to_message_id=reply)
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A Developer of Remi just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_photo(
                    "https://telegra.ph/file/b59f7d7fcefc04d857a66.jpg",
                    reply_to_message_id=reply)
                continue
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_photo(
                    "https://telegra.ph/file/da2de395cc06c20da973c.jpg",
                    reply_to_message_id=reply)
                continue
